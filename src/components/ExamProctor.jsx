                ...
                {phase === 'warning1' && (
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
                        ...
                        <motion.div initial={{ scale: 0.85, y: 30 }} animate={{ scale: 1, y: 0 }}
                            ...
                            <h2 style={{ fontSize: '1.8rem', fontWeight: '900', marginBottom: '12px', color: '#f59e0b' }}>⚠️ Warning {warnings}/2</h2>
                            <p style={{ color: '#e5e7eb', fontSize: '1rem', lineHeight: '1.6', marginBottom: '8px' }}>
                                You switched tabs or left the exam window.
                            </p>
                            <p style={{ color: '#f87171', fontWeight: '700', marginBottom: '32px' }}>
                                If this happens again, you will be <strong>permanently banned</strong> from this exam.
                            </p>
