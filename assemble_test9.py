...
with open("tmp_test9_q1_20.json", "r", encoding="utf-8") as f:
    q1 = json.load(f)
with open("tmp_test9_q21_40.json", "r", encoding="utf-8") as f:
    q2 = json.load(f)
with open("tmp_test9_q41_60.json", "r", encoding="utf-8") as f:
    q3 = json.load(f)
...
print("Practice Test 9 successfully appended!")
